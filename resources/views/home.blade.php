    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <hr>
                <div class="my-2">
                    <a href="{{ route('new_task') }}" class="btn btn-primary">Criar Nova Tarefa...</a>
                    <a href="{{route('tarefasInvisiveis')}}" class="btn btn-danger"><i class="fa fa-eye-slash" aria-hidden="true">Tarefas Escondidas</i></a>
                </div>
                ...
                @if ($tasks->count() === 0)
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        ...
                        <strong>Sem tarefas para serem realizadas. Parabéns!</strong>
                    </div>
                    <script>
                        $(".alert").alert();
                    </script>
                            ...
                            @foreach ($tasks as $task)
                                <tr>
                                    ...
                                    <td scope="row">
                                        ...
                                        {{-- Visualizar --}}
                                        @if ($task->visible === 1)
                                            <a href="{{ route('esconderTarefa', ['id' => $task->id]) }}"
                                                class="btn btn-info btn-sm"><i class="fa fa-eye-slash"
                                                    aria-hidden="true">Esconder Tarefa</i></a>
                                        @else
                                            <a href="{{ route('visualizarTarefa', ['id' => $task->id]) }}"
                                                class="btn btn-success btn-sm"><i class="fa fa-eye" aria-hidden="true">Não
                                                    Visualizar</i></a>
                                        @endif
                                        {{-- -Deletar --}}
